<template>
  <div class="main">
    <div class="wrap">
      <div class="title">
        <img src="../../assets/zjimg/zjtitle.png">
      </div>
      <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
        <a-tabs

          :tabBarStyle="{ textAlign: 'center', borderBottom: 'unset',border:'none' }"
        >
          ...
          <a-tab-pane key="tab1" tab="">
            <div class="userWrap">
              ...
              <div class="userNameWrap">
                <img src="../../assets/zjimg/icon-login-user.png"/>
              </div>
              <a-form-item>
            ...
            <div class="userWrap">
              <div class="userNameWrap">
                <img src="../../assets/zjimg/icon-login-pwd.png"/>
              </div>
                <a-form-item>
                  <a-input
        ...
        <a-form-item style="margin:10px auto">
...
<style lang="less" scoped>
  ...
  .title {
    ...
    /*background: url("../../assets/zjimg/zjtitle.png") no-repeat;*/
    /*background: 100% 100%;*/
    z-index: 100;
    overflow-x: hidden;
    border-radius: 10px;
